...
\protect\hypertarget{ux30c7ux30fcux30bfux306eux8aadux307fux8fbcux307f-1}{}
\begin{itemize}
\tightlist
\item
...
\FunctionTok{plot}\NormalTok{(precincts}\SpecialCharTok{$}\NormalTok{prior\_pro\_russian, precincts}\SpecialCharTok{$}\NormalTok{pro\_russian,}
     ...
     \AttributeTok{main =} \StringTok{"Relationship between Prior and Current Vote Shares"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[height=0.3\textheight]{DSS_Ch04_files/figure-beamer/unnamed-chunk-2-1} \end{center}
\end{frame}
...
\SpecialCharTok{{-}}\FloatTok{11.45} \SpecialCharTok{+}\NormalTok{ (}\FloatTok{0.74}\NormalTok{) }\SpecialCharTok{*} \DecValTok{60}
\end{Highlighting}
\end{Shaded}

...
\hypertarget{ux306aux305cux4e0dux78baux5b9fux6027ux3092ux6e2cux308bux306eux304b}{%
\section{7.1
なぜ不確実性を測るのか？}\label{ux306aux305cux4e0dux78baux5b9fux6027ux3092ux6e2cux308bux306eux304b}}

\begin{frame}{推測統計学の課題}
\protect\hypertarget{ux63a8ux6e2cux7d71ux8a08ux5b66ux306eux8ab2ux984c}{}
\begin{itemize}
\tightlist
\item
...
\begin{frame}[fragile]{BES データの読み込み (1)}
\protect\hypertarget{bes-ux30c7ux30fcux30bfux306eux8aadux307fux8fbcux307f-1}{}
\begin{itemize}
\tightlist
\item
...
\CommentTok{\# bes \textless{}{-} read.csv("https://ayumu{-}tanaka.github.io/QSS/DSS\_Data/BES.csv")}
...
\begin{frame}[fragile]{標本平均の95\%信頼区間 (2)}
\protect\hypertarget{ux6a19ux672cux5e73ux5747ux306e95ux4fe1ux983cux533aux9593-2}{}
\begin{itemize}
\tightlist
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{nrow}\NormalTok{(bes1)}
\NormalTok{sample\_mean }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(bes1}\SpecialCharTok{$}\NormalTok{leave)}
\NormalTok{se }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{var}\NormalTok{(bes1}\SpecialCharTok{$}\NormalTok{leave)}\SpecialCharTok{/}\NormalTok{n)}

\CommentTok{\# 95\%信頼区間 (大標本の場合: 推定値 ± 1.96 * SE)}
...
\CommentTok{\# （参考）URLから直接読み込むことも可能}
\CommentTok{\# star \textless{}{-} read.csv("https://ayumu{-}tanaka.github.io/QSS/DSS\_Data/STAR.csv")}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{平均の差の信頼区間 (2)}
\protect\hypertarget{ux5e73ux5747ux306eux5deeux306eux4fe1ux983cux533aux9593-2}{}
\scriptsize
...
\NormalTok{se\_diff }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{var}\NormalTok{(treatment)}\SpecialCharTok{/}\FunctionTok{length}\NormalTok{(treatment) }\SpecialCharTok{+} \FunctionTok{var}\NormalTok{(control)}\SpecialCharTok{/}\FunctionTok{length}\NormalTok{(control))}

\CommentTok{\# 95\%信頼区間}
\FunctionTok{c}\NormalTok{(diff\_means }\SpecialCharTok{{-}} \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ se\_diff, diff\_means }\SpecialCharTok{+} \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ se\_diff)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{ux4eeeux8aacux691cux5b9a}{%
...
\protect\hypertarget{ux5e73ux5747ux306eux5deeux306eux691cux5b9a-zux691cux5b9atux691cux5b9a}{}
\scriptsize
...
\begin{frame}[fragile]{UA\_survey データの読み込み (1)}
\protect\hypertarget{ua_survey-ux30c7ux30fcux30bfux306eux8aadux307fux8fbcux307f-1}{}
\begin{itemize}
\tightlist
\item
...
\CommentTok{\# （参考）URLから直接読み込むことも可能}
\CommentTok{\# uas \textless{}{-} read.csv("https://ayumu{-}tanaka.github.io/QSS/DSS\_Data/UA\_survey.csv")}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{回帰分析の結果の解釈 (2)}
\protect\hypertarget{ux56deux5e30ux5206ux6790ux306eux7d50ux679cux306eux89e3ux91c8-2}{}
\scriptsize

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(pro\_russian\_vote }\SpecialCharTok{\textasciitilde{}}\NormalTok{ russian\_tv }\SpecialCharTok{+}\NormalTok{ within\_25km, }\AttributeTok{data =}\NormalTok{ uas)}

...
\begin{frame}[fragile]{resume データセット}
\protect\hypertarget{resume-ux30c7ux30fcux30bfux30bbux30c3ux30c8}{}
\begin{itemize}
\tightlist
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 3. データの最初の数行を表示して中身を確認}

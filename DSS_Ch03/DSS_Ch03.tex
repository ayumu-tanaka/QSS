...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 1. ローカルに保存したBESデータの読み込み（推奨）}
...
\begin{center}\includegraphics[height=0.4\textheight]{DSS_Ch03_files/figure-beamer/unnamed-chunk-8-1} \end{center}
\end{frame}
...
\begin{frame}[fragile]{UK\_districts データの読み込み (1)}
\protect\hypertarget{uk_districts-ux30c7ux30fcux30bfux306eux8aadux307fux8fbcux307f-1}{}
\begin{itemize}
\tightlist
\item
...
\CommentTok{\# （参考）URLから直接読み込むことも可能}
\CommentTok{\# dis \textless{}{-} read.csv("https://ayumu{-}tanaka.github.io/QSS/DSS\_Data/UK\_districts.csv")}
...
\begin{frame}[fragile]{データの構造確認 (2)}
\protect\hypertarget{ux30c7ux30fcux30bfux306eux69cbux9020ux78baux8a8d-2}{}
\scriptsize

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 最初の数行を表示}
\FunctionTok{head}\NormalTok{(dis1)}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{散布図}
\protect\hypertarget{ux6563ux5e03ux56f3}{}
\begin{itemize}
\tightlist
\item
...
\begin{center}\includegraphics[height=0.4\textheight]{DSS_Ch03_files/figure-beamer/unnamed-chunk-12-1} \end{center}

...
\begin{frame}[fragile]{欠損データの処理}
\protect\hypertarget{ux6b20ux640dux30c7ux30fcux30bfux306eux51e6ux7406}{}
\begin{itemize}
\tightlist
\item
...
\begin{frame}[fragile]{二元度数表と二元比率表}
\protect\hypertarget{ux4e8cux5143ux5ea6ux6570ux8868ux3068ux4e8cux5143ux6bd4ux7387ux8868}{}
\begin{itemize}
\tightlist
\item
...
\FunctionTok{hist}\NormalTok{(bes1}\SpecialCharTok{$}\NormalTok{age[bes1}\SpecialCharTok{$}\NormalTok{leave }\SpecialCharTok{==} \DecValTok{1}\NormalTok{], }\AttributeTok{main =} \StringTok{"Supporters Age"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"Age"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{DSS_Ch03_files/figure-beamer/unnamed-chunk-7-1.pdf}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(dis1}\SpecialCharTok{$}\NormalTok{high\_education, dis1}\SpecialCharTok{$}\NormalTok{leave, }\AttributeTok{xlab =} \StringTok{"High Education (\%)"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Leave Vote (\%)"}\NormalTok{)}
...
\includegraphics{DSS_Ch03_files/figure-beamer/unnamed-chunk-11-1.pdf}
\end{frame}
